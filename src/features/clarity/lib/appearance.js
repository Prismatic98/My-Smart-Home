 ...
 * Moduls; Klarblick sticht damit nicht heraus, sondern liegt ruhig im
 * Farbklang der App.
 *
 ...
 *  - `styles/global.scss` als `--clarity-accent…` für die SCSS-Module.
 */
export const CLARITY_COLOR = 'blue';
